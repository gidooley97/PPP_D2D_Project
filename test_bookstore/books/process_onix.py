...
def process_data():
    ...
    for prod_el in product_elemnts[:10]:
        ...
        auth_els = prod_el.xpath(
            ".//d:Contributor[d:ContributorRole='A01']/d:PersonName", namespaces=ns)
        authors = []
        ...
        desc_el = prod_el.xpath(
            ".//d:TextContent[d:TextType='03']/d:Text", namespaces=ns)[0].text

        publ_status_el = prod_el.xpath(
